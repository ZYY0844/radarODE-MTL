...
_parser.add_argument('--eta_min', type=float, default=1e-6, help='eta_min for CosineAnnealingLR')
_parser.add_argument('--T_max', type=int, default=100, help='T_max for CosineAnnealingLR')
